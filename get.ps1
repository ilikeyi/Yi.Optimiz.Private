...
<#
	...
	$Script:PreServerList = @(
        ,"https://github.com/ilikeyi/Yi.Optimiz.Private/raw/main/update/latest.zip"
	)
#>
$Script:PreServerList = @(
	"https://github.com/ilikeyi/Yi.Optimiz.Private/raw/main/update/latest.zip"
	"https://fengyi.tel/download/solutions/update/Yi.Optimiz.Private/latest.zip"
)
...
$New_Root_Disk_Full_Solutions = "$($New_Root_Disk)Yi.Optimiz.Private"
